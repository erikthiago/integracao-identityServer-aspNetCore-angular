...
using IdentityServerArtigo.Admin.Api.Configuration;
using IdentityServerArtigo.Admin.Api.Configuration.Authorization;
using IdentityServerArtigo.Admin.Api.Configuration.Constants;
using IdentityServerArtigo.Admin.Api.ExceptionHandling;
using IdentityServerArtigo.Admin.Api.Helpers;
using IdentityServerArtigo.Admin.Api.Mappers;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
using IdentityServerArtigo.Admin.EntityFramework.Shared.DbContexts;
using IdentityServerArtigo.Admin.EntityFramework.Shared.Entities.Identity;
using Swashbuckle.AspNetCore.Swagger;

namespace IdentityServerArtigo.Admin.Api
{
