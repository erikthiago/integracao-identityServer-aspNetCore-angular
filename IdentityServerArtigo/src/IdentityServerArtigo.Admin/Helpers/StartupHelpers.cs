...
using IdentityServerArtigo.Admin.ExceptionHandling;
using IdentityServerArtigo.Admin.Middlewares;
using IdentityServerArtigo.Admin.Configuration;
using IdentityServerArtigo.Admin.Configuration.ApplicationParts;
using IdentityServerArtigo.Admin.Configuration.Constants;
using IdentityServerArtigo.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using IdentityServerArtigo.Admin.Helpers.Localization;

namespace IdentityServerArtigo.Admin.Helpers
{
