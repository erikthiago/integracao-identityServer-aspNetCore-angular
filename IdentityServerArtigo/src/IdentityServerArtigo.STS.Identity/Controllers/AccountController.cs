...
using IdentityServerArtigo.STS.Identity.Helpers;
using IdentityServerArtigo.STS.Identity.Helpers.Localization;
using IdentityServerArtigo.STS.Identity.ViewModels.Account;

namespace IdentityServerArtigo.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
