...
using SendGrid;
using Serilog;
using IdentityServerArtigo.STS.Identity.Configuration;
using IdentityServerArtigo.STS.Identity.Configuration.ApplicationParts;
using IdentityServerArtigo.STS.Identity.Configuration.Constants;
using IdentityServerArtigo.STS.Identity.Configuration.Intefaces;
using IdentityServerArtigo.STS.Identity.Helpers.Localization;
using IdentityServerArtigo.STS.Identity.Services;
using ILogger = Microsoft.Extensions.Logging.ILogger;

namespace IdentityServerArtigo.STS.Identity.Helpers
{
